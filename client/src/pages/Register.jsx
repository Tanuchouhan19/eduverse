    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12 ">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8 pt-10">
          ...
          <p className="mt-2 text-muted-foreground text-4xl font-black mb-2">Welcome! Stud👋</p>
          <p className="mt-2 text-muted-foreground">Create Account Here..</p>

        </div>

        {/* Login Card */}
        <div className="bg-card border border-border rounded-3xl p-8 shadow-2xl  border-gray-300">
          {/* User Type Toggle */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className={` bg-cyan-300 hover:bg-cyan-500 w-full py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 ${userType === "student"
            ...
            >
              Create An Account as {userType === "student" ? "Student" : "Admin"}
            </button>
          </form>
          ...
          <p className="mt-6 text-center text-muted-foreground">
            ...
            <Link to="/login" className="text-accent hover:text-accent/80 font-medium transition-colors underline">
              Log in Now
            </Link>
          </p>
        </div>
